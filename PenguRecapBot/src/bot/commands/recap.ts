  ...
  try {
    ...
    while (hasMoreMessages) {
      ...
      try {
        ...
        const relevantMessages = messageArray.filter((msg: any) => msg.createdAt > lastFetchTime);
        ...
        if (oldestMessage && oldestMessage.createdAt <= lastFetchTime) hasMoreMessages = false;
    ...
    // handle summarizer-specific errors separately
    try {
